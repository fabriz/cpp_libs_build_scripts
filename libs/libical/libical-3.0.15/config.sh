...
# Configuration script for ical 3.0.15
# Library release date: 2022/10/06

export FM_ICAL_NAME="libical"
export FM_ICAL_VERSION="3.0.15"
...
export FM_ICAL_HASH="4851b2826138253eb919a27e359627900d2ad1241ed6716a7a578b84767da8f3"
