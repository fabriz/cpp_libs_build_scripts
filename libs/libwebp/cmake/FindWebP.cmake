...
find_library(WEBP_ENCODE_LIBRARY NAMES webp libwebp PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
find_library(WEBP_DECODE_LIBRARY NAMES webpdecoder libwebpdecoder PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
find_library(WEBP_MUX_LIBRARY NAMES webpmux libwebpmux PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
find_library(WEBP_DEMUX_LIBRARY NAMES webpdemux libwebpdemux PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
find_library(WEBP_SHARPYUV_LIBRARY NAMES sharpyuv libsharpyuv PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
mark_as_advanced(WEBP_INCLUDE_DIR WEBP_ENCODE_LIBRARY WEBP_DECODE_LIBRARY WEBP_MUX_LIBRARY WEBP_DEMUX_LIBRARY WEBP_SHARPYUV_LIBRARY)
...
debugMessage("WEBP_SHARPYUV_LIBRARY: ${WEBP_SHARPYUV_LIBRARY}")
...
if(WEBP_FOUND)
    ...
    if(NOT TARGET WebP::WebP)
        ...
        target_include_directories(WebP::WebP INTERFACE "${WEBP_INCLUDE_DIR}")
    endif()
    ...
    if(WEBP_ENCODE_FOUND AND NOT TARGET WebP::Encode)
        ...
        if(EXISTS "${WEBP_SHARPYUV_LIBRARY}")
            target_link_libraries(WebP::Encode INTERFACE "${WEBP_SHARPYUV_LIBRARY}")
            list(APPEND WEBP_ENCODE_LIBRARIES ${WEBP_SHARPYUV_LIBRARY})
        endif()
    endif()
