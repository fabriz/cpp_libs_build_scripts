#!/bin/bash
# Configuration script for openssl 1.1.1i
# Library release date: 2020/12/08

export FM_OPENSSL_NAME="openssl"
export FM_OPENSSL_VERSION="1.1.1i"
...
export FM_OPENSSL_HASH="e8be6a35fe41d10603c3cc635e93289ed00bf34b79671a3a4de64fcee00d5242"
