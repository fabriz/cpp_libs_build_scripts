...
# Configuration script for openssl 1.1.1l
# Library release date: 2021/08/24

export FM_OPENSSL_NAME="openssl"
export FM_OPENSSL_VERSION="1.1.1l"
...
export FM_OPENSSL_HASH="0b7a3e5e59c34827fe0c3a74b7ec8baef302b98fa80088d7f9153aa16fa76bd1"
