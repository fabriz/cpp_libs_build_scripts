...
# Configuration script for openssl 1.1.1o
# Library release date: 2022/05/03

export FM_OPENSSL_NAME="openssl"
export FM_OPENSSL_VERSION="1.1.1o"
...
export FM_OPENSSL_HASH="9384a2b0570dd80358841464677115df785edb941c71211f75076d72fe6b438f"
