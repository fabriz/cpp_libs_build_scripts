...
# Configuration script for thrift 0.16.0
# Library release date: 2022/02/15

export FM_THRIFT_NAME="thrift"
export FM_THRIFT_VERSION="0.16.0"
...
export FM_THRIFT_HASH="44cf1b54b4ec1890576c85804acfa637"
