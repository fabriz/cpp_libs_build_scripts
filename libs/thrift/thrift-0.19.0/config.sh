...
# Configuration script for thrift 0.19.0
# Library release date: 2023/09/02

export FM_THRIFT_NAME="thrift"
export FM_THRIFT_VERSION="0.19.0"
...
export FM_THRIFT_HASH="f2074232cd80c83f30c030cb69ef68a8"
