...
# Configuration script for thrift 0.18.0
# Library release date: 2023/02/13

export FM_THRIFT_NAME="thrift"
export FM_THRIFT_VERSION="0.18.0"
...
export FM_THRIFT_HASH="f1b607c6d1cf8d87390dc5f1fb46c9b5"
