...
# Configuration script for thrift 0.15.0
# Library release date: 2021/09/11

export FM_THRIFT_NAME="thrift"
export FM_THRIFT_VERSION="0.15.0"
...
export FM_THRIFT_HASH="81954d55567e2996ba186f8776aa8b1b"
