...
# Build script for qrencode 4.1.1
...
buildCurrentArchitecture__linux_gcc()
{
    ...
    "${FM_CONFIG_CMAKE_COMMAND}" ${FM_TARGET_CMAKE_ARGUMENTS_GENERATE} \
        -DBUILD_SHARED_LIBS=False -DWITH_TOOLS=False -DWITH_TESTS=False > ${FM_CURRENT_ARCHITECTURE_LOG_FILE_CONFIGURE} 2>&1
    checkBuildStep
