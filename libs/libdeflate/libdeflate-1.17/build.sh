...
# Build script for libdeflate 1.17
...
buildCurrentArchitecture__linux_gcc()
{
    ...
    "${FM_CONFIG_CMAKE_COMMAND}" ${FM_TARGET_CMAKE_ARGUMENTS_GENERATE} \
        -DLIBDEFLATE_BUILD_SHARED_LIB=False -DLIBDEFLATE_BUILD_GZIP=False > ${FM_CURRENT_ARCHITECTURE_LOG_FILE_CONFIGURE} 2>&1
    checkBuildStep
