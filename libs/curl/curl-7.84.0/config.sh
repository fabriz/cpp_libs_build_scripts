...
# Configuration script for curl 7.84.0
# Library release date: 2022/06/27

export FM_CURL_NAME="curl"
export FM_CURL_VERSION="7.84.0"
...
export FM_CURL_HASH="2d118b43f547bfe5bae806d8d47b4e596ea5b25a6c1f080aef49fbcd817c5db8"
