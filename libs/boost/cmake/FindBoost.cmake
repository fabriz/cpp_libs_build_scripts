...
find_library(BOOST_URL_LIBRARY NAMES boost_url libboost_url PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
...
mark_as_advanced(BOOST_INCLUDE_DIR BOOST_ATOMIC_LIBRARY BOOST_CHRONO_LIBRARY BOOST_CONTAINER_LIBRARY BOOST_CONTEXT_LIBRARY 
    ...
    BOOST_THREAD_LIBRARY BOOST_TIMER_LIBRARY BOOST_TYPE_ERASURE_LIBRARY BOOST_UNIT_TEST_FRAMEWORK_LIBRARY BOOST_URL_LIBRARY
    BOOST_WAVE_LIBRARY BOOST_WSERIALIZATION_LIBRARY)
...
debugMessage("BOOST_URL_LIBRARY: ${BOOST_URL_LIBRARY}")
...
check_package_component_items(url REQUIRED_ITEMS BOOST_INCLUDE_DIR BOOST_URL_LIBRARY)
...
if(BOOST_FOUND)
    ...
    set(BOOST_URL_LIBRARIES ${BOOST_URL_LIBRARY})
    ...
    if(BOOST_URL_FOUND AND NOT TARGET Boost::url)
...
#    endif()
    ...
    set(Boost_ATOMIC_LIBRARIES ${BOOST_ATOMIC_LIBRARIES})
    set(Boost_CHRONO_LIBRARIES ${BOOST_CHRONO_LIBRARIES})
    set(Boost_CONTAINER_LIBRARIES ${BOOST_CONTAINER_LIBRARIES})
    set(Boost_CONTEXT_LIBRARIES ${BOOST_CONTEXT_LIBRARIES})
    set(Boost_CONTRACT_LIBRARIES ${BOOST_CONTRACT_LIBRARIES})
    set(Boost_COROUTINE_LIBRARIES ${BOOST_COROUTINE_LIBRARIES})
    set(Boost_DATE_TIME_LIBRARIES ${BOOST_DATE_TIME_LIBRARIES})
    set(Boost_EXCEPTION_LIBRARIES ${BOOST_EXCEPTION_LIBRARIES})
    set(Boost_FIBER_LIBRARIES ${BOOST_FIBER_LIBRARIES})
    set(Boost_FILESYSTEM_LIBRARIES ${BOOST_FILESYSTEM_LIBRARIES})
    set(Boost_GRAPH_LIBRARIES ${BOOST_GRAPH_LIBRARIES})
    set(Boost_IOSTREAMS_LIBRARIES ${BOOST_IOSTREAMS_LIBRARIES})
    set(Boost_JSON_LIBRARIES ${BOOST_JSON_LIBRARIES})
    set(Boost_LOCALE_LIBRARIES ${BOOST_LOCALE_LIBRARIES})
    set(Boost_LOG_LIBRARIES ${BOOST_LOG_LIBRARIES})
    set(Boost_LOG_SETUP_LIBRARIES ${BOOST_LOG_SETUP_LIBRARIES})
    set(Boost_NOWIDE_LIBRARIES ${BOOST_NOWIDE_LIBRARIES})
    set(Boost_PRG_EXEC_MONITOR_LIBRARIES ${BOOST_PRG_EXEC_MONITOR_LIBRARIES})
    set(Boost_PROGRAM_OPTIONS_LIBRARIES ${BOOST_PROGRAM_OPTIONS_LIBRARIES})
    set(Boost_RANDOM_LIBRARIES ${BOOST_RANDOM_LIBRARIES})
    set(Boost_REGEX_LIBRARIES ${BOOST_REGEX_LIBRARIES})
    set(Boost_SERIALIZATION_LIBRARIES ${BOOST_SERIALIZATION_LIBRARIES})
    set(Boost_SYSTEM_LIBRARIES ${BOOST_SYSTEM_LIBRARIES})
    set(Boost_TEST_EXEC_MONITOR_LIBRARIES ${BOOST_TEST_EXEC_MONITOR_LIBRARIES})
    set(Boost_THREAD_LIBRARIES ${BOOST_THREAD_LIBRARIES})
    set(Boost_TIMER_LIBRARIES ${BOOST_TIMER_LIBRARIES})
    set(Boost_TYPE_ERASURE_LIBRARIES ${BOOST_TYPE_ERASURE_LIBRARIES})
    set(Boost_UNIT_TEST_FRAMEWORK_LIBRARIES ${BOOST_UNIT_TEST_FRAMEWORK_LIBRARIES})
    set(Boost_URL_LIBRARIES ${BOOST_URL_LIBRARIES})
    set(Boost_WAVE_LIBRARIES ${BOOST_WAVE_LIBRARIES})
    set(Boost_WSERIALIZATION_LIBRARIES ${BOOST_WSERIALIZATION_LIBRARIES})
