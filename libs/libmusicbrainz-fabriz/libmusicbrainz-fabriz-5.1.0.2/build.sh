...
# Build script for libmusicbrainz-fabriz 5.1.0.2
...
buildCurrentArchitecture__linux_gcc()
{
    ...
    if [ -n "${FM_TARGET_CROSS_COMPILER_HOST-}" ]; then
        CROSS_COMPILATION_FLAGS="-DCMAKE_SYSTEM_NAME=Linux -DIMPORT_EXECUTABLES=${FM_ARG_BUILD_ROOT}/linux_gcc_x86_64_release/source/${FM_MUSICBRAINZ_FULL_NAME}/x86_64/tmp_build/ImportExecutables.cmake"
    fi
...
{
    local CROSS_COMPILATION_FLAGS="-DCMAKE_SYSTEM_NAME=Linux -DIMPORT_EXECUTABLES=${FM_ARG_BUILD_ROOT}/linux_gcc_x86_64_release/source/${FM_MUSICBRAINZ_FULL_NAME}/x86_64/tmp_build/ImportExecutables.cmake"
...
buildCurrentArchitecture__macos_clang()
{
    ...
    if [ ${FM_TARGET_IS_CROSS_COMPILING} = true ]; then
        CROSS_COMPILATION_FLAGS="-DCMAKE_SYSTEM_NAME=Darwin -DIMPORT_EXECUTABLES=${FM_ARG_BUILD_ROOT}/macos_clang_${FM_HOST_ARCHITECTURE}_release/source/${FM_MUSICBRAINZ_FULL_NAME}/${FM_HOST_ARCHITECTURE}/tmp_build/ImportExecutables.cmake"
    fi
...
buildCurrentArchitecture__ios_clang()
{
    ...
    local CROSS_COMPILATION_FLAGS="-DIMPORT_EXECUTABLES=${FM_ARG_BUILD_ROOT}/macos_clang_${FM_HOST_ARCHITECTURE}_release/source/${FM_MUSICBRAINZ_FULL_NAME}/${FM_HOST_ARCHITECTURE}/tmp_build/ImportExecutables.cmake"
