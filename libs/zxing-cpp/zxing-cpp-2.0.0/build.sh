...
# Build script for zxing-cpp 2.0.0
...
buildCurrentArchitecture__linux_gcc()
{
    ...
    "${FM_CONFIG_CMAKE_COMMAND}" ${FM_TARGET_CMAKE_ARGUMENTS_GENERATE} \
        -DBUILD_SHARED_LIBS=False -DBUILD_WRITERS=True -DBUILD_READERS=True \
        -DBUILD_EXAMPLES=False -DBUILD_BLACKBOX_TESTS=False -DBUILD_UNIT_TESTS=False \
        -DBUILD_PYTHON_MODULE=False -DBUILD_DEPENDENCIES=LOCAL > ${FM_CURRENT_ARCHITECTURE_LOG_FILE_CONFIGURE} 2>&1
    checkBuildStep
