...
buildCurrentArchitecture__linux_gcc()
{
    ...
    "${FM_CONFIG_CMAKE_COMMAND}" ${FM_TARGET_CMAKE_ARGUMENTS_GENERATE} \
        -DBUILD_SHARED_LIBS=False -DZXING_WRITERS=ON -DZXING_READERS=True \
        -DZXING_EXAMPLES=False -DZXING_BLACKBOX_TESTS=False -DZXING_UNIT_TESTS=False \
        -DZXING_PYTHON_MODULE=False -DZXING_DEPENDENCIES=LOCAL > ${FM_CURRENT_ARCHITECTURE_LOG_FILE_CONFIGURE} 2>&1
    checkBuildStep
