...
find_library(BROTLI_COMON_LIBRARY NAMES brotlicommon libbrotlicommon PATHS "${CPPLIBS_VARIANT_ROOT}/lib" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
...
mark_as_advanced(BROTLI_INCLUDE_DIR BROTLI_COMON_LIBRARY BROTLI_ENCODE_LIBRARY BROTLI_DECODE_LIBRARY)

set(BROTLI_VERSION_STRING ${CPPLIBS_LIBRARY_KNOWN_VERSION})

debugMessage("BROTLI_INCLUDE_DIR: ${BROTLI_INCLUDE_DIR}")
debugMessage("BROTLI_COMON_LIBRARY: ${BROTLI_COMON_LIBRARY}")
...
check_package_component_items(Encode REQUIRED_ITEMS BROTLI_INCLUDE_DIR BROTLI_COMON_LIBRARY BROTLI_ENCODE_LIBRARY)
check_package_component_items(Decode REQUIRED_ITEMS BROTLI_INCLUDE_DIR BROTLI_COMON_LIBRARY BROTLI_DECODE_LIBRARY)
...
if(BROTLI_FOUND)
    ...
    if(BROTLI_ENCODE_FOUND AND NOT TARGET Brotli::Encode)
        ...
        if(EXISTS "${BROTLI_COMON_LIBRARY}")
            target_link_libraries(Brotli::Encode INTERFACE "${BROTLI_COMON_LIBRARY}")
            list(APPEND BROTLI_ENCODE_LIBRARIES ${BROTLI_COMON_LIBRARY})
        endif()
    endif()
    ...
    if(BROTLI_DECODE_FOUND AND NOT TARGET Brotli::Decode)
        ...
        if(EXISTS "${BROTLI_COMON_LIBRARY}")
            target_link_libraries(Brotli::Decode INTERFACE "${BROTLI_COMON_LIBRARY}")
            list(APPEND BROTLI_DECODE_LIBRARIES ${BROTLI_COMON_LIBRARY})
        endif()
    endif()
endif()
