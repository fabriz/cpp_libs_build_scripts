...
# Configuration script for wt 4.10.1
# Library release date: 2023/09/20

export FM_WT_NAME="wt"
export FM_WT_VERSION="4.10.1"
...
export FM_WT_HASH="f6d6114416a628604793197cd077066a9d4d98799bbb288b97de42f66705bde5"
