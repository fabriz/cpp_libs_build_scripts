...
# Configuration script for wt 4.9.1
# Library release date: 2023/01/20

export FM_WT_NAME="wt"
export FM_WT_VERSION="4.9.1"
...
export FM_WT_HASH="253c61779623ed125bdd604a7b7fe48e64bd991548d17180f040bfa88ccafd98"
