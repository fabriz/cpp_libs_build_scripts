...
# Configuration script for libxml2 2.11.0
# Library release date: 2023/04/28

export FM_LIBXML2_NAME="libxml2"
export FM_LIBXML2_VERSION="2.11.0"
...
export FM_LIBXML2_HASH="b1a2fca3f7722d6c35a4f24974a1b5800e4d84ec5cb756bc61ef2b8c75a19e36"
