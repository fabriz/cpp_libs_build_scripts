...
# Build script for libxml2 2.14.4
...
{
    sed -i.orig 's/set(CMAKE_C_STANDARD 11)/#set(CMAKE_C_STANDARD 11)/' ./CMakeLists.txt
...
buildCurrentArchitecture__linux_gcc()
{
    ...
    "${FM_CONFIG_CMAKE_COMMAND}" ${FM_TARGET_CMAKE_ARGUMENTS_GENERATE} \
        -DBUILD_SHARED_LIBS=False -DLIBXML2_WITH_PYTHON=False -DLIBXML2_WITH_DEBUG=False > ${FM_CURRENT_ARCHITECTURE_LOG_FILE_CONFIGURE} 2>&1
    checkBuildStep
