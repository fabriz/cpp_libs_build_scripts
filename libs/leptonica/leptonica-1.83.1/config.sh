...
# Configuration script for leptonica 1.83.1
# Library release date: 2023/01/26

export FM_LEPTONICA_NAME="leptonica"
export FM_LEPTONICA_VERSION="1.83.1"
...
export FM_LEPTONICA_HASH="8f18615e0743af7df7f50985c730dfcf0c93548073d1f56621e4156a8b54d3dd"
