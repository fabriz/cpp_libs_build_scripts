...
set FM_GLOBAL_COMPILER_VERSION=%FM_GLOBAL_MINGW_32_VERSION%
set FM_GLOBAL_ARCHITECTURE=i386

set PATH=%FM_GLOBAL_MINGW_32_INSTALL_PATH%\bin;%FM_GLOBAL_CMAKE_INSTALL_PATH%\bin;%PATH%;%FM_GLOBAL_MSYS64_INSTALL_PATH%\usr\local\bin;%FM_GLOBAL_MSYS64_INSTALL_PATH%\usr\bin;%FM_GLOBAL_MSYS64_INSTALL_PATH%\bin;%FM_GLOBAL_MSYS64_INSTALL_PATH%\opt\bin
