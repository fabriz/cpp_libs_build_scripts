...
set FM_TARGET_COMPILER_VERSION=14.3
set FM_TARGET_TOOLCHAIN=windows_msvc
set FM_TARGET_PLATFORM=windows_msvc2022
...
call "%FM_CONFIG_MSVC_VCVARSALL_BAT_PATH%" amd64_x86 -vcvars_ver=%FM_TARGET_COMPILER_VERSION%
