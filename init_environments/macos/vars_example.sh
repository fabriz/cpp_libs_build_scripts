...
export FM_GLOBAL_NUM_PROCESSES=$(sysctl -n hw.logicalcpu)

# Android NDK path and API level
export FM_GLOBAL_ANDROID_API_LEVEL=29
export FM_GLOBAL_ANDROID_NDK_INSTALL_PATH=/Users/fabrizio/Android/ndk/android-ndk-r21d
...
export FM_GLOBAL_TARBALL_CACHE=/Users/fabrizio/libs/libs_source
export FM_GLOBAL_BUILD_ROOT=/Users/fabrizio/libs/build
export FM_GLOBAL_DEPLOY_ROOT=/Users/fabrizio/libs/libs
