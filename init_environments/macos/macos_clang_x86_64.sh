...
export FM_TARGET_TOOLCHAIN_COMMON_CFLAGS="-fPIC -Wextra -Wall -W -mmacosx-version-min=10.10 -arch x86_64"
export FM_TARGET_TOOLCHAIN_COMMON_CXXFLAGS="-stdlib=libc++ -std=c++14"
