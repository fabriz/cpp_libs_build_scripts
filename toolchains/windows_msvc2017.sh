...
initToolchainTools()
{
    ...
    FM_CONFIG_COMMON_CFLAGS="-I${FM_LIBS_INSTALL_INCLUDES_WINDOWS} -nologo -Zi -Zc:inline -Zc:wchar_t -Zc:strictStrings -bigobj -FS -DUNICODE -DWIN32 -D_WIN32_WINNT=0x0601"
